...
namespace Job_Manager.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,text,date,reminder")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("id,text,date,reminder")] Job job)
        {
            if (id != job.id)
            {
                return NotFound();
